...
export default function SurveyDetailPage() {
  ...
  // --- CLEANUP FUNCTIONS (Simplified for brevity as they work) ---
  const handleDeleteInvalid = async () => { /* ... existing code ... */ };
  const handleArchiveScores = async () => { /* ... existing code ... */ };
    ...
    <div className="min-h-screen bg-slate-50 p-8 font-sans">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center gap-4">
            <Link href="/dashboard"><Button variant="ghost" size="sm"><ArrowLeft className="w-4 h-4 mr-2" /> Back to Dashboard</Button></Link>
        </div>
        ...
        {/* ... (Rest of the Cards: Stats, Hygiene, Unit Grid) ... */}
        {/* Paste the rest of your existing UI code here, specifically the Hygiene Card and Unit Grid from previous step */}
        
        {/* IMPORTANT: Update the "Global Status" Card to use the new handler */}
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            ...
                            <Button 
                                ...
                                onClick={handleRunGlobalAnalysis} // <--- NEW HANDLER CONNECTED
                            >
                ...
                <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {unitStats.map((unit) => {
                                ...
                                return (
                                    <Link key={unit.unit_id} href={`/dashboard/${surveyId}/unit/${unit.unit_id}`}>
                                        <Card className="hover:shadow-md transition-shadow cursor-pointer group border-slate-200 h-full">
