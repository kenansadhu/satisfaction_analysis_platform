...
- [ ] **Analyze data for Study Programs:** In the survey, there are comments related to study program. However, different from other units, where the comments from every student in every faculty or study programs is related to them, the comments related to study programs are not related to only their own study program. Think of how this process can be differentiated and discuss your ideas with the developer.
